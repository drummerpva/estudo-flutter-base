...
mixin _$ExampleFreezedState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<String> name, String message) showBanner,
    required TResult Function(List<String> name) data,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<String> name, String message)? showBanner,
    TResult? Function(List<String> name)? data,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$_ExampleFreezedStateBannerCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<String> name, String message});
}
...
class _$_ExampleFreezedStateBanner implements _ExampleFreezedStateBanner {
  _$_ExampleFreezedStateBanner(
      {required final List<String> name, required this.message})
      : _name = name;
  ...
  @override
  String toString() {
    return 'ExampleFreezedState.showBanner(name: $name, message: $message)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_name), message);
  ...
  TResult when<TResult extends Object?>({
    ...
    return showBanner(name, message);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return showBanner?.call(name, message);
  }
...
class _$_ExampleFreezedStateData implements _ExampleFreezedStateData {
  _$_ExampleFreezedStateData({required final List<String> name}) : _name = name;
  ...
  @override
  String toString() {
    return 'ExampleFreezedState.data(name: $name)';
  }
...
abstract class _ExampleFreezedStateData implements ExampleFreezedState {
  factory _ExampleFreezedStateData({required final List<String> name}) =
